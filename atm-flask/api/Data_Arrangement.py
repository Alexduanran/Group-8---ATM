...
def stock_data(test, company, rep, info, startDate, train_iteration, drunkness_index, num_of_starting_points, structure):
    """
    format:
    ...
    neural_network = NeuralNetwork(drunkness_index, structure=structure)
    ...
    return (predicted_arr, original_arr)
